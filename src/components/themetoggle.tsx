...
const ThemeToggle: React.FC = () => {
  ...
  return (
    <button
      ...
      className="bg-bgsecondary rounded-full border-none cursor-pointer w-10 h-10 flex items-center justify-center hover:ring-4 transition-all duration-300 ring-accent/25"
    >
      <svg
