...
const ThreeDDiv: React.FC = () => {
  return (
    <div className="z-50 shadow-sm ">
      ...
      {/* top */}
      <div className="absolute -top-[6px] left-0 w-0 h-0 border-r-[8px] border-l-[12px] border-t-[8px] border-transparent border-l-bordersecondary border-t-bordersecondary rotate-180"></div>
      {/* right */}
